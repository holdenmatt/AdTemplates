...
}}};a.createElement=function(d,c,f){var e=document.createElement(d);for(var b in c){if(c.hasOwnProperty(b)){e.setAttribute(b,c[b])}}a.setStyles(e,f);return e};a.addStyles=function(d){var c=a.createElement("style",{type:"text/css"});var e=document.createTextNode(d);if(c.styleSheet){c.styleSheet.cssText=e.nodeValue}else{c.appendChild(e)}var b=document.getElementsByTagName("head")[0];b.appendChild(c)};a.hasClass=function(d,c){var b=new RegExp("(\\s|^)"+c+"(\\s|$)");return d.className.match(b)};a.addClass=function(c,b){if(!a.hasClass(c,b)){c.className+=" "+b}};a.removeClass=function(d,c){var b=new RegExp("(\\s|^)"+c+"(\\s|$)");d.className=d.className.replace(b," ")};return a})();
/*!
 * Carousel.js
 *
 * A touch-enabled image carousel.
 */
window.TouchCarousel=window.TouchCarousel||{};(function(){var b=window.TouchCarousel.util;var f=document.querySelectorAll("div.Carousel");if(f.length>0){f=f[f.length-1]}else{console.log("Cannot activate Carousel: no ul.Carousel element found")}var c={snap:true,momentum:false,hScrollbar:false,vScrollbar:false,wheelAction:"none",snapThreshold:5};
function e(n,j){this.wrapper=n;this.options=j;var m=parseInt(n.style.width,10),g=parseInt(n.style.height,10);if(!m||!g){throw new Error("div.Carousel must have a width/height")}var l=n.querySelector("ul");if(!l){throw new Error("div.Carousel must contain an <ul> tag")}var h=l.querySelectorAll("li");if(h.length===0){throw new Error("div.Carousel > ul must contain <li> items")}b.addClass(this.wrapper,"wrapper");this.scroller=b.createElement("div",{"class":"scroller"},{width:m*h.length+"px",height:"100%"});for(var k=0;k<h.length;k++){b.setStyles(h[k],{width:m+"px",height:g+"px"})}this.scroller.appendChild(l);this.wrapper.appendChild(this.scroller);this.wrapper.style.display="block";j.onScrollEnd=this.onScrollEnd;this.iScroll=new iScroll(this.wrapper,j);this.indicator=new a(this);this.wrapper.appendChild(this.indicator.el)}e.prototype.onScrollEnd=function(){document.querySelector(".PageIndicator > li.active").className="";document.querySelector(".PageIndicator > li:nth-child("+(this.currPageX+1)+")").className="active"
};function a(h){this.carousel=h;var g=this.el=b.createElement("ul",{"class":"PageIndicator"});var i=h.iScroll.pagesX.map(function(j){return b.createElement("li")});i[0].className="active";i.forEach(function(j){g.appendChild(j)})}function d(){b.addStyles(window.TouchCarousel.styles);var g=new e(f,c)}document.addEventListener("DOMContentLoaded",d,false)})();window.TouchCarousel.styles=".wrapper{position:relative;overflow:hidden}.scroller>ul{margin:0;padding:0;list-style:none}.scroller>ul>li{position:relative;display:block;float:left;-webkit-box-sizing:border-box;box-sizing:border-box;-webkit-user-select:none;user-select:none}.PageIndicator,.PageIndicator>li{display:block;float:left;list-style:none;padding:0;margin:0}.PageIndicator{width:110px;padding:12px 0 0 30px;margin-top:-30px}.PageIndicator>li{text-indent:-9999em;width:8px;height:8px;-webkit-border-radius:4px;border-radius:4px;background:#ddd;margin-right:4px}.PageIndicator>li.active{background:#888}.PageIndicator>li:last-child{margin:0}";