...
if(String(p)!==q){throw new Error("Attribute must be an integer: "+n)}return p}function g(n){this.el=n;this.href=i(n,"data-href");this.width=j(n,"data-width");this.height=j(n,"data-height");this.ul=n.querySelector("ul");if(!this.ul){throw new Error("Carousel div must contain an <ul> tag")}this.items=this.ul.querySelectorAll("li");if(this.items.length===0){throw new Error("Carousel ul must contain <li> items")}}g.prototype.initialize=function(){e(this.el,"wrapper");h(this.el,{width:this.width+"px",height:this.height+"px"});for(var p=0;p<this.items.length;p++){h(this.items[p],{width:this.width+"px",height:this.height+"px"})}this.scroller=a("div",{"class":"scroller"},{width:(this.width*this.items.length)+"px",height:"100%"});this.el.appendChild(this.scroller);this.scroller.appendChild(this.ul);this.overlay=this.el.querySelector("span.Overlay");if(this.overlay){var n=a("div",{"class":"OverlayContainer"},{width:this.width+"px"});this.scroller.appendChild(n);n.appendChild(this.overlay)}this.el.style.display="block";
var o={snap:true,momentum:false,hScrollbar:false,wheelAction:"none",snapThreshold:5,onScrollStart:this.onScrollStart.bind(this),onScrollMove:this.onScrollMove.bind(this),onTouchEnd:this.onTouchEnd.bind(this)};this.iScroll=new iScroll(this.el,o);this.indicator=new m(this);this.el.appendChild(this.indicator.el)};g.prototype.onTap=function(n){window.open(this.href,"_blank")};g.prototype.onSwipe=function(){};g.prototype.onScrollStart=function(n){if(this.overlay){d(this.overlay.parentNode);this.overlay=null}};g.prototype.onScrollMove=function(p){if(!this.scrolledOut){var o=this.iScroll.options.snapThreshold,n=this.iScroll.absDistX>o,q=this.iScroll.absDistY>o;if(n||q){this.scrolledOut=true}}};g.prototype.onTouchEnd=function(p){if(p.type==="mouseout"){return}if(this.scrolledOut){var n=function(){p.stopPropagation();p.target.removeEventListener("click",n,false)};p.target.addEventListener("click",n,false);this.scrolledOut=false;this.onSwipe()}else{var o=this.iScroll.currPageX;this.onTap(o)}};function m(o){this.carousel=o;
