 ...
 * Carousel.js
 */
window.Carousel=(function(){function k(o){var p=navigator.userAgent,q="_blank";if(p.match(/Android/i)||p.match(/Kindle/i)||p.match(/Silk-Accelerated/i)){q="_self"
}window.open(o,q)}if(!Function.prototype.bind){Function.prototype.bind=function(q){var t=Array.prototype.slice,p=t.call(arguments,1),o=this,s=function(){},r=function(){return o.apply(this instanceof s?this:(q||{}),p.concat(t.call(arguments)))};s.prototype=this.prototype;r.prototype=new s();return r}}function i(o,p){for(var q in p){if(p.hasOwnProperty(q)){o.style[q]=p[q]}}}function a(q,p,s){var r=document.createElement(q);for(var o in p){if(p.hasOwnProperty(o)){r.setAttribute(o,p[o])}}i(r,s);return r}function b(q){var p=a("style",{type:"text/css"}),o=document.getElementsByTagName("head")[0];var r=document.createTextNode(q);if(p.styleSheet){p.styleSheet.cssText=r.nodeValue}else{p.appendChild(r)}o.appendChild(p)}function c(q,p){var o=new RegExp("(\\s|^)"+p+"(\\s|$)");return q.className.match(o)}function e(p,o){if(p&&!c(p,o)){p.className+=" "+o}}function l(q,p){if(q){var o=new RegExp("(\\s|^)"+p+"(\\s|$)");q.className=q.className.replace(o," ")}}function d(o){o.style.transition=o.style.webkitTransition="opacity .25s ease-out";
