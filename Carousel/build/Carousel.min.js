 ...
 * Carousel.js
 */
window.Carousel=(function(){function k(p){var o=a("a",{href:p,target:"_blank"});document.body.appendChild(o);var q=document.createEvent("MouseEvents");
q.initMouseEvent("click",true,true,document.defaultView,1,0,0,0,0,false,false,false,false,0,null);o.dispatchEvent(q)}if(!Function.prototype.bind){Function.prototype.bind=function(q){var t=Array.prototype.slice,p=t.call(arguments,1),o=this,s=function(){},r=function(){return o.apply(this instanceof s?this:(q||{}),p.concat(t.call(arguments)))};s.prototype=this.prototype;r.prototype=new s();return r}}function i(o,p){for(var q in p){if(p.hasOwnProperty(q)){o.style[q]=p[q]}}}function a(q,p,s){var r=document.createElement(q);for(var o in p){if(p.hasOwnProperty(o)){r.setAttribute(o,p[o])}}i(r,s);return r}function b(q){var p=a("style",{type:"text/css"}),o=document.getElementsByTagName("head")[0];var r=document.createTextNode(q);if(p.styleSheet){p.styleSheet.cssText=r.nodeValue}else{p.appendChild(r)}o.appendChild(p)}function c(q,p){var o=new RegExp("(\\s|^)"+p+"(\\s|$)");return q.className.match(o)}function e(p,o){if(p&&!c(p,o)){p.className+=" "+o}}function l(q,p){if(q){var o=new RegExp("(\\s|^)"+p+"(\\s|$)");
q.className=q.className.replace(o," ")}}function d(o){o.style.transition=o.style.webkitTransition="opacity .25s ease-out";if(o.style.webkitTransition){o.style.opacity=0}else{o.style.visibility="hidden"}}function h(p,o){var q=p.getAttribute(o);if(!q){throw new Error("Missing required attribute: "+o)}return q}function j(p,o){var r=h(p,o),q=parseInt(r,10);if(String(q)!==r){throw new Error("Attribute must be an integer: "+o)}return q}function g(q){this.el=q;this.href=h(q,"data-href");this.width=j(q,"data-width");this.height=j(q,"data-height");this.ul=q.querySelector("ul");if(!this.ul){throw new Error("Carousel div must contain an <ul> tag")}this.items=[];var o=this.ul.querySelectorAll("li"),r,s;for(var p=0;p<o.length;p++){r=o[p];s=r.getAttribute("data-image-src");if(s){r.appendChild(a("img",{src:s}))}if(r.querySelectorAll("img").length===1){this.items.push(r)}else{r.parentNode.removeChild(r)}}if(this.items.length===0){throw new Error("Carousel ul must contain <li> items with either a child img tag or data-image-src attribute.")
}}g.prototype.initialize=function(){e(this.el,"wrapper");i(this.el,{width:this.width+"px",height:this.height+"px"});for(var q=0;q<this.items.length;q++){i(this.items[q],{width:this.width+"px",height:this.height+"px"})}this.scroller=a("div",{"class":"scroller"},{width:(this.width*this.items.length)+"px",height:"100%"});this.el.appendChild(this.scroller);this.scroller.appendChild(this.ul);this.overlay=this.el.querySelector("span.Overlay");if(this.overlay){var o=a("div",{"class":"OverlayContainer"},{width:this.width+"px"});this.scroller.appendChild(o);o.appendChild(this.overlay)}this.el.style.display="block";var p={snap:true,momentum:false,hScrollbar:false,wheelAction:"none",snapThreshold:5,onScrollStart:this.onScrollStart.bind(this),onScrollMove:this.onScrollMove.bind(this),onTouchEnd:this.onTouchEnd.bind(this)};this.iScroll=new iScroll(this.el,p);this.indicator=new n(this);this.el.appendChild(this.indicator.el)};g.prototype.onTap=function(o){k(this.href)};g.prototype.onSwipe=function(){};
g.prototype.onScrollStart=function(o){if(this.overlay){d(this.overlay.parentNode);this.overlay=null}};g.prototype.onScrollMove=function(q){if(!this.scrolledOut){var p=this.iScroll.options.snapThreshold,o=this.iScroll.absDistX>p,r=this.iScroll.absDistY>p;if(o||r){this.scrolledOut=true}}};g.prototype.onTouchEnd=function(q){if(q.type==="mouseout"){return}if(this.scrolledOut){var o=function(){q.stopPropagation();q.target.removeEventListener("click",o,false)};q.target.addEventListener("click",o,false);this.scrolledOut=false;this.onSwipe()}else{var p=this.iScroll.currPageX;this.onTap(p)}};function n(p){this.carousel=p;this.el=a("div",{"class":"PageIndicator"});var o=a("ul");this.el.appendChild(o);p.iScroll.pagesX.forEach(function(q){o.appendChild(a("li"))});this.update();this.carousel.iScroll.options.onScrollEnd=this.update.bind(this)}n.prototype.update=function(){var r=this.el.querySelector("li.active");l(r,"active");var p=this.carousel.iScroll.currPageX+1,o="li:nth-child("+p+")",q=this.el.querySelector(o);
e(q,"active")};var m;var f=document.querySelectorAll("div.Carousel");if(f.length>0){m=new g(f[f.length-1])}else{throw new Error("div.Carousel not found")}document.addEventListener("DOMContentLoaded",function(){b(window.Carousel.styles);m.initialize()},false);return g})();window.Carousel.styles=".Carousel.wrapper{position:relative;overflow:hidden}.Carousel>.scroller>ul{margin:0;padding:0;list-style:none}.Carousel>.scroller>ul>li{position:relative;display:block;float:left;clear:none;margin:0;padding:0;-webkit-box-sizing:border-box;box-sizing:border-box;-webkit-user-select:none;user-select:none}.PageIndicator{position:absolute;width:100%;height:30px;bottom:0;background:#000;opacity:.6}.PageIndicator ul{position:absolute;text-align:center;width:100%;height:100%;margin:0;padding:0;padding-top:5px}.PageIndicator li{display:inline-block;width:8px;height:8px;min-height:8px;-webkit-border-radius:4px;border-radius:4px;background:#555;margin-right:4px}.PageIndicator li.active{background:#fff}.PageIndicator li:last-child{margin:0}.Carousel .OverlayContainer{position:absolute;text-align:center;left:0;top:50%;height:40px;margin-top:-20px!important;z-index:100}.Carousel .Overlay{display:inline-block;padding:10px;background-color:rgba(0,0,0,0.7);color:#fff;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:bold;border-radius:10px;-webkit-border-radius:10px}";