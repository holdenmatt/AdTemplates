 ...
 * Carousel.js
 */
window.Carousel=(function(){var b={};b.open=function(o,p){window.open(o,"_blank")};b.onSwipe=function(){};if(!Function.prototype.bind){Function.prototype.bind=function(q){var t=Array.prototype.slice,p=t.call(arguments,1),o=this,s=function(){},r=function(){return o.apply(this instanceof s?this:(q||{}),p.concat(t.call(arguments)))
};s.prototype=this.prototype;r.prototype=new s();return r}}function j(o,p){for(var q in p){if(p.hasOwnProperty(q)){o.style[q]=p[q]}}}function a(q,p,s){var r=document.createElement(q);for(var o in p){if(p.hasOwnProperty(o)){r.setAttribute(o,p[o])}}j(r,s);return r}function c(q){var p=a("style",{type:"text/css"}),o=document.getElementsByTagName("head")[0];var r=document.createTextNode(q);if(p.styleSheet){p.styleSheet.cssText=r.nodeValue}else{p.appendChild(r)}o.appendChild(p)}function d(q,p){var o=new RegExp("(\\s|^)"+p+"(\\s|$)");return q.className.match(o)}function f(p,o){if(p&&!d(p,o)){p.className+=" "+o}}function l(q,p){if(q){var o=new RegExp("(\\s|^)"+p+"(\\s|$)");q.className=q.className.replace(o," ")}}function e(o){o.style.transition=o.style.webkitTransition="opacity .25s ease-out";if(o.style.webkitTransition){o.style.opacity=0}else{o.style.visibility="hidden"}}function i(p,o){var q=p.getAttribute(o);if(!q){throw new Error("Missing required attribute: "+o)}return q}function k(p,o){var r=i(p,o),q=parseInt(r,10);
if(String(q)!==r){throw new Error("Attribute must be an integer: "+o)}return q}function h(o){this.el=o;this.href=i(o,"data-href");this.width=k(o,"data-width");this.height=k(o,"data-height");this.ul=o.querySelector("ul");if(!this.ul){throw new Error("Carousel div must contain an <ul> tag")}this.items=this.ul.querySelectorAll("li");if(this.items.length===0){throw new Error("Carousel ul must contain <li> items")}}h.prototype.initialize=function(){f(this.el,"wrapper");j(this.el,{width:this.width+"px",height:this.height+"px"});for(var q=0;q<this.items.length;q++){j(this.items[q],{width:this.width+"px",height:this.height+"px"})}this.scroller=a("div",{"class":"scroller"},{width:(this.width*this.items.length)+"px",height:"100%"});this.el.appendChild(this.scroller);this.scroller.appendChild(this.ul);this.overlay=this.el.querySelector("span.Overlay");if(this.overlay){var o=a("div",{"class":"OverlayContainer"},{width:this.width+"px"});this.scroller.appendChild(o);o.appendChild(this.overlay)}this.el.style.display="block";
var p={snap:true,momentum:false,hScrollbar:false,wheelAction:"none",onScrollStart:this.onScrollStart.bind(this),onScrollMove:this.onScrollMove.bind(this),onTouchEnd:this.onTouchEnd.bind(this)};this.iScroll=new iScroll(this.el,p);this.indicator=new n(this);this.el.appendChild(this.indicator.el)};h.prototype.onScrollStart=function(o){if(this.overlay){e(this.overlay.parentNode)}};h.prototype.onScrollMove=function(q){if(!this.scrolledOut){var p=this.iScroll.options.snapThreshold,o=this.iScroll.absDistX>p,r=this.iScroll.absDistY>p;if(o||r){this.scrolledOut=true}}};h.prototype.onTouchEnd=function(q){if(q.type==="mouseout"){return}if(this.scrolledOut){var o=function(){q.stopPropagation();q.target.removeEventListener("click",o,false)};q.target.addEventListener("click",o,false);this.scrolledOut=false;b.onSwipe()}else{var p=this.iScroll.currPageX;b.open(this.href,p)}};function n(p){this.carousel=p;var o=this.el=a("ul",{"class":"PageIndicator"});p.iScroll.pagesX.forEach(function(q){o.appendChild(a("li"))
});this.update();this.carousel.iScroll.options.onScrollEnd=this.update.bind(this)}n.prototype.update=function(){var r=this.el.querySelector("li.active");l(r,"active");var p=this.carousel.iScroll.currPageX+1,o="li:nth-child("+p+")",q=this.el.querySelector(o);f(q,"active")};var m;var g=document.querySelectorAll("div.Carousel");if(g.length>0){m=new h(g[g.length-1])}else{throw new Error("div.Carousel not found")}document.addEventListener("DOMContentLoaded",function(){c(window.Carousel.styles);m.initialize()},false);return b})();window.Carousel.styles=".Carousel.wrapper{position:relative;overflow:hidden}.Carousel>.scroller>ul{margin:0;padding:0;list-style:none}.Carousel>.scroller>ul>li{position:relative;display:block;float:left;-webkit-box-sizing:border-box;box-sizing:border-box;-webkit-user-select:none;user-select:none}.PageIndicator{position:absolute;text-align:center;width:100%;height:30px;bottom:0;padding:0;margin:0;background:#000;opacity:.6}.PageIndicator>li{display:inline-block;width:8px;height:8px;-webkit-border-radius:4px;border-radius:4px;background:#555;margin:11px 4px 0 0}.PageIndicator>li.active{background:#fff}.PageIndicator>li:last-child{margin:0}.Carousel .OverlayContainer{position:absolute;text-align:center;left:0;top:50%;height:40px;margin-top:-20px;z-index:100}.Carousel .Overlay{display:inline-block;padding:10px;background-color:rgba(0,0,0,0.7);color:#fff;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:bold;border-radius:10px;-webkit-border-radius:10px}";