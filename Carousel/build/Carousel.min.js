...
};s.prototype=this.prototype;r.prototype=new s();return r}}function j(o,p){for(var q in p){if(p.hasOwnProperty(q)){o.style[q]=p[q]}}}function a(q,p,s){var r=document.createElement(q);for(var o in p){if(p.hasOwnProperty(o)){r.setAttribute(o,p[o])}}j(r,s);return r}function c(q){var p=a("style",{type:"text/css"}),o=document.getElementsByTagName("head")[0];var r=document.createTextNode(q);if(p.styleSheet){p.styleSheet.cssText=r.nodeValue}else{p.appendChild(r)}o.appendChild(p)}function d(q,p){var o=new RegExp("(\\s|^)"+p+"(\\s|$)");return q.className.match(o)}function f(p,o){if(p&&!d(p,o)){p.className+=" "+o}}function l(q,p){if(q){var o=new RegExp("(\\s|^)"+p+"(\\s|$)");q.className=q.className.replace(o," ")}}function e(o){o.style.display="none"}function i(p,o){var q=p.getAttribute(o);if(!q){throw new Error("Missing required attribute: "+o)}return q}function k(p,o){var r=i(p,o),q=parseInt(r,10);if(String(q)!==r){throw new Error("Attribute must be an integer: "+o)}return q}function h(o){this.el=o;
this.href=i(o,"data-href");this.width=k(o,"data-width");this.height=k(o,"data-height");this.ul=o.querySelector("ul");if(!this.ul){throw new Error("Carousel div must contain an <ul> tag")}this.items=this.ul.querySelectorAll("li");if(this.items.length===0){throw new Error("Carousel ul must contain <li> items")}}h.prototype.initialize=function(){f(this.el,"wrapper");j(this.el,{width:this.width+"px",height:this.height+"px"});for(var q=0;q<this.items.length;q++){j(this.items[q],{width:this.width+"px",height:this.height+"px"})}this.scroller=a("div",{"class":"scroller"},{width:(this.width*this.items.length)+"px",height:"100%"});this.el.appendChild(this.scroller);this.scroller.appendChild(this.ul);this.overlay=this.el.querySelector("span.Overlay");if(this.overlay){var o=a("div",{"class":"OverlayContainer"},{width:this.width+"px"});this.scroller.appendChild(o);o.appendChild(this.overlay)}this.el.style.display="block";var p={snap:true,momentum:false,hScrollbar:false,wheelAction:"none",onScrollStart:this.onScrollStart.bind(this),onScrollMove:this.onScrollMove.bind(this),onTouchEnd:this.onTouchEnd.bind(this)};
