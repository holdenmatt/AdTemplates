...
this.scroller.appendChild(n);n.appendChild(this.overlay)}this.el.style.display="block";var o={snap:true,momentum:false,hScrollbar:false,wheelAction:"none",snapThreshold:5,onScrollStart:this.onScrollStart.bind(this),onScrollMove:this.onScrollMove.bind(this),onTouchEnd:this.onTouchEnd.bind(this)};this.iScroll=new iScroll(this.el,o);this.indicator=new m(this);this.el.appendChild(this.indicator.el)};g.prototype.onTap=function(n){window.open(this.href)};g.prototype.onSwipe=function(){};g.prototype.onScrollStart=function(n){if(this.overlay){d(this.overlay.parentNode);this.overlay=null}};g.prototype.onScrollMove=function(p){if(!this.scrolledOut){var o=this.iScroll.options.snapThreshold,n=this.iScroll.absDistX>o,q=this.iScroll.absDistY>o;if(n||q){this.scrolledOut=true}}};g.prototype.onTouchEnd=function(p){if(p.type==="mouseout"){return}if(this.scrolledOut){var n=function(){p.stopPropagation();p.target.removeEventListener("click",n,false)};p.target.addEventListener("click",n,false);this.scrolledOut=false;
